...
var questions = [{ id: 'quest-1', name: 'Вопрос №1', answers: ['Ответ №1', 'Ответ №2', 'Ответ №3'] }, { id: 'quest-2', name: 'Вопрос №2', answers: ['Ответ №1', 'Ответ №2', 'Ответ №3'] }, { id: 'quest-3', name: 'Вопрос №3', answers: ['Ответ №1', 'Ответ №2', 'Ответ №3'] }];
var trueAnswers = {
    'quest-1': 0,
    'quest-2': 1,
    'quest-3': 2
...
$(function () {
    ...
    $('.modal_button').on('click', function () {
        $('.modal_window').animate({ opacity: 0 }, 500, function () {
            $(undefined).css("display", "none"); //убираем модальное окно
